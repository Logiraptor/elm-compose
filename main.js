			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_1: _elm_lang$core$Json_Encode$string(
						_justinmimbs$elm_date_extra$Date_Extra$toIsoString(c.start))
				}
				]));
	};
	return _elm_lang$core$Json_Encode$object(
...
var _user$project$Budget$replaceAt = F3(
	function (index, list, func) {
		var elem = _elm_lang$core$List$head(
...
var _user$project$Budget$removeAt = F2(
	function (i, l) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$List$take, i, l),
			A2(_elm_lang$core$List$drop, i + 1, l));
	});
var _user$project$Budget$nextCharge = function (c) {
	var _p3 = c.freq;
	if (_p3.ctor === 'Once') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
		var newStart = A3(_justinmimbs$elm_date_extra$Date_Extra$add, _p3._1, _p3._0, c.start);
		return _elm_lang$core$Maybe$Just(
			_elm_lang$core$Native_Utils.update(
				c,
				{start: newStart}));
...
var _user$project$Budget$projectCharge = F2(
	function (until, charge) {
		if (_elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Basics$GT,
			A2(_justinmimbs$elm_date_extra$Date_Extra$compare, charge.start, until))) {
			return _elm_lang$core$Native_List.fromArray(
				[]);
		} else {
			var newCharge = _user$project$Budget$nextCharge(charge);
			var _p4 = newCharge;
			if (_p4.ctor === 'Nothing') {
				return _elm_lang$core$Native_List.fromArray(
					[
				...
				return A2(
					_elm_lang$core$List_ops['::'],
					{date: charge.start, amount: charge.amount},
					A2(_user$project$Budget$projectCharge, until, _p4._0));
			}
		}
	});
...
var _user$project$Budget$projectBalance = function (charges) {
	var addTransaction = F2(
		function (transaction, balance) {
			return {date: transaction.date, balance: balance.balance + transaction.amount};
		});
	var endDate = A3(_justinmimbs$elm_date_extra$Date_Extra$fromCalendarDate, 2017, _elm_lang$core$Date$Jan, 1);
	var transactions = A2(
	...
	var balances = A3(
		...
		addTransaction,
		{
			date: A3(_justinmimbs$elm_date_extra$Date_Extra$fromCalendarDate, 2016, _elm_lang$core$Date$Jan, 1),
			balance: 0
		},
		sortedTransactions);
	return balances;
};
var _user$project$Budget$viewBalance = function (b) {
	return A2(
...
var _user$project$Budget$Transaction = F2(
	function (a, b) {
...
var _user$project$Budget$ChangeChargeFreq = F2(
	function (a, b) {
		return {ctor: 'ChangeChargeFreq', _0: a, _1: b};
	});
var _user$project$Budget$ChangeChargeAmount = F2(
	function (a, b) {
		return {ctor: 'ChangeChargeAmount', _0: a, _1: b};
	});
var _user$project$Budget$RenameCharge = F2(
	function (a, b) {
		return {ctor: 'RenameCharge', _0: a, _1: b};
	});
	...
	function (i, charge) {
		...
		var stringToFreq = function (s) {
			...
			switch (_p9) {
				...
				case 'every':
					return A2(_user$project$Budget$Every, 1, _justinmimbs$elm_date_extra$Date_Extra$Month);
				default:
					return _user$project$Budget$Once;
			}
		};
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_user$project$Budget$RemoveCharge(i))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(charge.start)),
						A2(
						_elm_lang$html$Html$input,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('text'),
								_elm_lang$html$Html_Attributes$value(charge.name),
								_elm_lang$html$Html_Events$onInput(
								_user$project$Budget$RenameCharge(i))
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$selected(isOnce)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('once')
									])),
								A2(
								_elm_lang$html$Html$option,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$selected(isEvery)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('every')
									]))
							]))
					]),
				function () {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Add Charge')
					])),
				A2(
				_elm_lang$html$Html$ul,
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$indexedMap, _user$project$Budget$viewCharge, model.charges)),
				A2(
		...
		switch (_p22.ctor) {
			case 'AddCharge':
				var newCharge = {
					name: 'NewCharge',
					amount: 0.0,
					freq: _user$project$Budget$Once,
					start: A7(_justinmimbs$elm_date_extra$Date_Extra$fromParts, 2016, _elm_lang$core$Date$Jan, 1, 0, 0, 0, 0)
				};
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
